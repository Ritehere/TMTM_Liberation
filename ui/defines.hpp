...
#define COLOR_BROWN { 0.19, 0.74, 0.31, 0.75 }
#define COLOR_GREEN { 0.07, 0.30, 0.20, 0.75 }
#define COLOR_GREEN_ALPHA { 0.07, 0.30, 0.20, 0.4 }
#define COLOR_GREEN_NOALPHA { 0.07, 0.30, 0.20, 1 }
#define COLOR_LIGHTGREEN { 0.2, 0.35, 0.2, 0.4 }
#define COLOR_LIGHTGRAY { 0.78, 0.95, 0.85, 0.8 }
#define COLOR_LIGHTGRAY_ALPHA { 0.78, 0.95, 0.85, 0.55 }
