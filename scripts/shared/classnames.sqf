...
if ( isNil "opfor_sentry") then { opfor_sentry = "CUP_O_RU_Soldier_EMR"; };
if ( isNil "opfor_rifleman") then { opfor_rifleman = "CUP_O_RU_Soldier_EMR"; };
if ( isNil "opfor_grenadier") then { opfor_grenadier = "CUP_O_RU_Soldier_GL_EMR"; };
if ( isNil "opfor_squad_leader") then { opfor_squad_leader = "CUP_O_RU_Soldier_SL_EMR"; };
if ( isNil "opfor_team_leader") then { opfor_team_leader = "CUP_O_RU_Soldier_TL_EMR"; };
if ( isNil "opfor_marksman") then { opfor_marksman = "CUP_O_RU_Soldier_Marksman_EMR"; };
if ( isNil "opfor_machinegunner") then { opfor_machinegunner = "CUP_O_RU_Soldier_AR_EMR"; };
if ( isNil "opfor_heavygunner") then { opfor_heavygunner = "CUP_O_RU_Soldier_MG_EMR"; };
if ( isNil "opfor_medic") then { opfor_medic = "CUP_O_RU_Medic_EMR"; };
if ( isNil "opfor_rpg") then { opfor_rpg = "CUP_O_RU_Soldier_LAT_EMR"; };
if ( isNil "opfor_at") then { opfor_at = "CUP_O_RU_Soldier_HAT_EMR"; };
if ( isNil "opfor_aa") then { opfor_aa = "CUP_O_RU_Soldier_AA_EMR"; };
if ( isNil "opfor_officer") then { opfor_officer = "CUP_O_RU_Officer_EMR"; };
if ( isNil "opfor_sharpshooter") then { opfor_sharpshooter = "CUP_O_RUS_Soldier_Marksman_Autumn"; };
if ( isNil "opfor_sniper") then { opfor_sniper = "CUP_O_RU_Sniper_EMR"; };
if ( isNil "opfor_engineer") then { opfor_engineer = "CUP_O_RU_Engineer_EMR"; };
if ( isNil "opfor_paratrooper") then { opfor_paratrooper = "CUP_O_RUS_SpecOps_Scout_Autumn"; };
if ( isNil "opfor_mrap") then { opfor_mrap = "CUP_O_GAZ_Vodnik_MedEvac_RU"; };
if ( isNil "opfor_mrap_armed") then { opfor_mrap_armed = "CUP_O_GAZ_Vodnik_AGS_RU"; };
if ( isNil "opfor_transport_helo") then { opfor_transport_helo = "CUP_O_Mi8_medevac_RU"; };
if ( isNil "opfor_transport_truck") then { opfor_transport_truck = "CUP_O_Ural_RU"; };
if ( isNil "opfor_fuel_truck") then { opfor_fuel_truck = "CUP_O_Ural_Refuel_RU"; };
if ( isNil "opfor_ammo_truck") then { opfor_ammo_truck = "CUP_O_Ural_Reammo_RU"; };
...
if ( isNil "opfor_flag") then { opfor_flag = "FlagCarrierRU"; };
