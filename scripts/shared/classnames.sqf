...
infantry_units = [
	...
	["B_T_recon_M_F",5,0,0],
	["B_T_Recon_Sharpshooter_F",8,0,0],
...
if ( count blufor_squad_inf == 0 ) then { blufor_squad_inf = [ "B_T_Soldier_SL_F","B_T_Soldier_TL_F","B_T_Soldier_AR_F","B_HeavyGunner_F","B_T_medic_F","B_T_Soldier_GL_F","B_T_Soldier_LAT_F","B_T_Soldier_LAT_F","B_T_soldier_M_F","B_Sharpshooter_F" ]; };
...
if ( count blufor_squad_recon == 0 ) then { blufor_squad_recon = [ "B_T_recon_TL_F","B_T_recon_F","B_T_recon_exp_F","B_T_recon_medic_F","B_T_recon_LAT_F","B_T_recon_LAT_F","B_T_recon_M_F","B_Recon_Sharpshooter_F","B_T_recon_F" ]; };
...
vehicle_repair_sources = [] + vehicle_repair_sources_extension + [ "B_T_APC_Tracked_01_CRV_F", "C_Offroad_01_repair_F", "B_Truck_01_Repair_F", "B_Slingload_01_Repair_F", "JNS_Skycrane_Pod_Repair_BLU_Black" ];
if ( isNil "vehicle_rearm_sources_extension" ) then { vehicle_rearm_sources_extension = [] };
vehicle_rearm_sources = [] + vehicle_rearm_sources_extension + [ "B_T_APC_Tracked_01_CRV_F", "B_Truck_01_ammo_F", "B_Slingload_01_Ammo_F", "JNS_Skycrane_Pod_Ammo_BLU_Black" ];
...
if ( isNil "opfor_sharpshooter") then { opfor_sharpshooter = "O_T_Soldier_M_F"; };
...
if ( isNil "opfor_transport_helo") then { opfor_transport_helo = "O_Heli_Transport_04_bench_black_F"; };
...
if ( isNil "opfor_fuel_container") then { opfor_fuel_container = "Land_Pod_Heli_Transport_04_fuel_black_F"; };
if ( isNil "opfor_ammo_container") then { opfor_ammo_container = "Land_Pod_Heli_Transport_04_ammo_black_F"; };
